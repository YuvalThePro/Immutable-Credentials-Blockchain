...
public class ProofOfAuthority {
     ...
     * The proposer is selected by: {@code blockIndex % authorizedValidators.size()}.
     ...
     * @return the Validator whose turn it is to propose, or null if no validators exist
     * @throws IllegalArgumentException if blockIndex is negative
     */
    public Validator getCurrentProposer(int blockIndex) {
        // TODO: implement round-robin selection using blockIndex % authorizedValidators.size()
